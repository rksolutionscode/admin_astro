...
class Parvai extends StatefulWidget {
  @override
  _parvaiState createState() => _parvaiState();
}

class _parvaiState extends State<Parvai> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  final TextEditingController noteController = TextEditingController();

  Future<void> addDataToFirestore(String note) async {
    await FirebaseFirestore.instance.collection('parvai').add({
      'note': note,
          ...
          (context) => AlertDialog(
            ...
            content: TextField(
              ...
              decoration: InputDecoration(
                hintText:
                    "குறிப்புகளை உள்ளிடவும் (ஒவ்வொன்றையும் ஒரே வரியில்)...",
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text("பல குறிப்புகள் சேர்க்கப்பட்டுள்ளன."),
                    ),
                  );
                },
              ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        tooltip: 'பல குறிப்புகளை சேர்க்கவும்',
      ),
      body: SafeArea(
        child: Row(
          children: [
                                                  ...
                                                  showDialog(
                                                    ...
                                                    builder:
                                                        (
                                                          ...
                                                          content: Text(
                                                            "நீக்கு உறுதிப்படுத்துகிறீர்களா?",
                                                          ),
                                                          actions: [
                                                            TextButton(
                                                              child: Text(
