...
class Prasanam extends StatefulWidget {
  @override
  _PrasanamState createState() => _PrasanamState();
}

class _PrasanamState extends State<Prasanam> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  final TextEditingController noteController = TextEditingController();

  Future<void> addDataToFirestore(String note) async {
    await FirebaseFirestore.instance.collection('prasanam').add({
      'note': note,
